...
const Hero = ({images, teaser, content, label1, url1, label2, url2, background}: HeroHomeType) => {
    const screen = useScreenSize();

    return (
        <>
            <div className={`${background ? "bg-accent-shine" : "bg-featured-shine"} full-width lg:h-hero`}>
                <section
                    ...
                    <Content
                        ...
                        url1={url1}
                        url2={url2}
                        headingClassName="[&>em]:text-accent [&>em]:not-italic"
